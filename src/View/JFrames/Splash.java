...
public class Splash extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(88, 112, 223));
        jPanel1.setForeground(new java.awt.Color(254, 254, 254));

        Title.setFont(new java.awt.Font("Century Gothic", 1, 20)); // NOI18N
        Title.setText(" HARDWARE STORE MANAGER");
        Title.setMaximumSize(new java.awt.Dimension(290, 30));
        Title.setMinimumSize(new java.awt.Dimension(290, 30));
        Title.setPreferredSize(new java.awt.Dimension(200, 20));

        Logo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/View/Images/VOIA.png"))); // NOI18N
